...
export const apiSections: readonly ApiSection[] = [
...

  {
    ...
    rows: [
      ...
      ["NetworkOperation", "Network management: create, remove, list_all, get, set_default, inspect, sync, create_default_network, restore"],
      ["ImageOperation", "Image operations: pull, import_, remove, list_, get, set_default, inspect, warm, find_existing_image"],
      ["KernelOperation", "Kernel operations: pull, list_all, get, set_default, remove, inspect"],
      ["KeyOperation", "SSH key registry: add, create, list_all, get, inspect, remove, set_default, get_defaults, clear_defaults, export"],
      ["BinaryOperation", "Binary management: pull, list_local, list_remote, get, set_default, remove, remove_by_version, ensure_default"],
      ["HostOperation", "Host init/clean/reset, privilege checks, KVM access, binary checks, state, get_running_vms, get_ip_forward_status"],
    ...
    models: [
      ...
      },
      {
        ...
        fields: [
          ...
          { field: "ssh_keys", type: "list[str]", description: "SSH key names injected into the VM" },
          { field: "ssh_user", type: "str | None", description: "Default SSH user for the VM" },
        ],
        resolvedFields: [
      ...
      },
      {
        ...
        fields: [
          ...
          { field: "leases", type: "list[NetworkLeaseItem] | None", description: "IP leases associated with this network" },
          { field: "iptables_rules", type: "list[IPTablesRuleItem] | None", description: "iptables rules associated with this network" },
        ],
      },
      {
        title: "ImageItem",
        ...
        fields: [
          ...
          { field: "deleted_at", type: "str | None", description: "ISO 8601 soft-delete timestamp" },
          { field: "vms", type: "list[VMInstanceItem] | None", description: "VMs referencing this image for relation enrichment" },
        ],
      },
      {
        title: "KernelItem",
      ...
      },
      {
        ...
        fields: [
          ...
          { field: "network_id", type: "str", description: "Network ID this lease belongs to" },
          { field: "ipv4", type: "str", description: "Leased IPv4 address" },
          { field: "vm_id", type: "str | None", description: "VM ID this lease is assigned to" },
          { field: "leased_at", type: "str", description: "ISO 8601 lease timestamp" },
          { field: "expires_at", type: "str | None", description: "ISO 8601 lease expiry timestamp" },
        ],
      },
      {
        title: "IPTablesRuleItem",
        name: "IPTablesRuleItem",
        fields: [
          { field: "id", type: "int | None", description: "Rule ID" },
          { field: "table_name", type: "str", description: "iptables table (filter, nat, mangle, raw, security)" },
          { field: "chain_name", type: "str", description: "iptables chain name" },
          { field: "rule_type", type: "str", description: "Rule type: masquerade, forward_in, forward_out, nocloudnet_input" },
          { field: "protocol", type: "str", description: "Protocol: tcp, udp, icmp, all" },
          { field: "source", type: "str", description: "Source CIDR or IP" },
          { field: "destination", type: "str", description: "Destination CIDR or IP" },
          { field: "in_interface", type: "str", description: "Input interface" },
          { field: "out_interface", type: "str", description: "Output interface" },
          { field: "target", type: "str", description: "iptables target: ACCEPT, DROP, MASQUERADE, etc." },
          { field: "sport", type: "int", description: "Source port" },
          { field: "dport", type: "int", description: "Destination port" },
          { field: "network_id", type: "str", description: "Network ID this rule belongs to" },
          { field: "is_active", type: "bool", description: "Whether the rule is currently active" },
          { field: "command_string", type: "str | None", description: "Full iptables command string" },
          { field: "comment_tag", type: "str | None", description: "iptables comment tag" },
          { field: "created_at", type: "str | None", description: "ISO 8601 creation timestamp" },
          { field: "last_verified_at", type: "str | None", description: "ISO 8601 last verification timestamp" },
        ],
      },
    ],
  },
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "VMOperation.create(inputs: VMCreateInput, *, on_progress: Callable[[ProgressEvent], None] | None = None) -> OperationResult[VMInstanceItem] | NeedsInteraction",
            description:
            ...
            parameters: [
              ...
              { param: "inputs.binary_id", type: "str | None", default: "None", description: "Firecracker/jailer binary ID" },
              { param: "inputs.skip_cleanup", type: "bool", default: "False", description: "Skip cleanup on failure" },
              { param: "inputs.skip_ci_network_config", type: "bool", default: "False", description: "Skip cloud-init network config" },
              { param: "inputs.keep_cloud_init_iso", type: "bool", default: "False", description: "Keep cloud-init ISO after creation" },
            ],
          ...
          {
            signature: "VMOperation.remove(inputs: VMInput) -> BatchResult[VMInstanceItem]",
            description:
          ...
          {
            signature: "VMOperation.list_all(status: VMStatus | list[VMStatus] | None = None) -> list[VMInstanceItem]",
          ...
          {
            signature: "VMOperation.start(inputs: VMInput) -> BatchResult[VMInstanceItem]",
            description: "Start one or more stopped VMs.",
          },
          {
            signature: "VMOperation.stop(inputs: VMInput) -> BatchResult[VMInstanceItem]",
          ...
          {
            signature: "VMOperation.pause(inputs: VMInput) -> BatchResult[VMInstanceItem]",
            description: "Pause one or more running VMs.",
          },
          {
            signature: "VMOperation.resume(inputs: VMInput) -> BatchResult[VMInstanceItem]",
            description: "Resume one or more paused VMs.",
          },
          {
            signature: "VMOperation.reboot(inputs: VMInput) -> BatchResult[VMInstanceItem]",
            description: "Reboot one or more VMs.",
          },
          {
            signature: "VMOperation.snapshot(inputs: VMInput, mem_out: Path, state_out: Path) -> OperationResult[VMInstanceItem]",
            description: "Create a snapshot of a single VM's memory and state. Requires memory and state file output paths.",
          },
          {
            signature: "VMOperation.load_snapshot(inputs: VMInput, mem_in: Path, state_in: Path, resume_after: bool | None = None) -> OperationResult[VMInstanceItem]",
            description: "Load a VM from memory and state snapshot files. Optionally resume after loading.",
          },
          {
            signature: "VMOperation.inspect(inputs: VMInput, tree: bool = False) -> dict[str, Any]",
          ...
          },
          {
            ...
            description: "Export a VM's configuration to a portable VMExportConfig object.",
          },
          {
            signature: "VMOperation.import_(inputs: VMImportInput, *, on_progress: Callable[[ProgressEvent], None] | None = None) -> OperationResult[VMInstanceItem] | NeedsInteraction",
            description: "Create a VM from a portable config file. Resolves images, kernels, binaries, and networks.",
          },
        ],
      },
    ],
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "NetworkOperation.create(inputs: NetworkCreateInput) -> OperationResult[NetworkItem] | NeedsInteraction",
          ...
          {
            signature: "NetworkOperation.remove(inputs: NetworkInput, force: bool = False) -> OperationResult[NetworkItem]",
          ...
          {
            signature: "NetworkOperation.set_default(inputs: NetworkInput) -> OperationResult[NetworkItem]",
            description: "Set a network as the default for VM creation.",
          },
          {
            signature: "NetworkOperation.inspect(inputs: NetworkInput, is_json: bool = False) -> NetworkItem | dict[str, Any]",
            description: "Show detailed network information including leases and iptables rules.",
          },
          {
            signature: "NetworkOperation.sync(network_id: str | None = None) -> OperationResult[dict[str, dict[str, int]]]",
            description: "Sync iptables rules between database and host. Optionally target a specific network.",
          },
          {
            signature: "NetworkOperation.create_default_network() -> OperationResult[NetworkItem]",
          ...
          {
            signature: "NetworkOperation.restore() -> OperationResult[list[str]]",
            description: "Restore networks from database to host state. Recreates bridges, TAPs, and iptables rules.",
          },
        ],
      },
    ],
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "ImageOperation.pull(inputs: ImagePullInput, *, on_progress: Callable[[ProgressEvent], None] | None = None) -> OperationResult[ImageItem] | NeedsInteraction",
            description: "Pull (download) a VM rootfs image (qcow2, tar, or raw), convert to ext4, and register in the database.",
            parameters: [
              ...
              { param: "inputs.partition", type: "int | None", default: "None", description: "Root partition number" },
              { param: "inputs.disabled_detectors", type: "list[str]", default: "[]", description: "Detectors to disable: type, label, size, filesystem" },
            ],
          },
          {
            signature: "ImageOperation.import_(inputs: ImageImportInput, *, on_progress: Callable[[ProgressEvent], None] | None = None) -> OperationResult[ImageItem]",
            ...
            parameters: [
              ...
              { param: "inputs.format", type: "str | None", default: "None", description: "Image format: qcow2, raw, tar-rootfs, or auto" },
              { param: "inputs.arch", type: "str | None", default: "None", description: "Image architecture" },
              { param: "inputs.partition", type: "int | None", default: "None", description: "Root partition number" },
              { param: "inputs.force", type: "bool", default: "False", description: "Overwrite existing" },
              { param: "inputs.skip_optimization", type: "bool", default: "False", description: "Skip shrink and compression" },
          ...
          {
            signature: "ImageOperation.remove(inputs: ImageInput, force: bool = False) -> BatchResult[ImageItem]",
          ...
          {
            signature: "ImageOperation.list_(inputs: ImageInput | None = None, *, remote: bool = False) -> list[ImageItem] | list[ImageSpec]",
          ...
          {
            signature: "ImageOperation.set_default(inputs: ImageInput) -> OperationResult[ImageItem]",
            description: "Set an image as the default for new VMs.",
          },
          {
            signature: "ImageOperation.inspect(inputs: ImageInput, is_json: bool = False) -> ImageItem | dict[str, Any]",
            description: "Show detailed information about an image including compression stats and storage details.",
          },
          {
            signature: "ImageOperation.warm(inputs: ImageInput, *, on_progress: Callable[[ProgressEvent], None] | None = None) -> OperationResult[list[Path]]",
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "KernelOperation.pull(inputs: KernelPullInput, *, on_progress: Callable[[ProgressEvent], None] | None = None) -> OperationResult[KernelItem] | NeedsInteraction",
            description: "Pull (download) or build a Firecracker kernel. Requires kernel_type (firecracker or official).",
            parameters: [
          ...
          {
            signature: "KernelOperation.remove(inputs: KernelInput, force: bool = False) -> BatchResult[KernelItem]",
          ...
          {
            signature: "KernelOperation.inspect(inputs: KernelInput, is_json: bool = False) -> KernelItem | dict[str, Any]",
            description: "Show detailed kernel information.",
          },
          {
            signature: "KernelOperation.set_default(inputs: KernelInput) -> OperationResult[KernelItem]",
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "KeyOperation.create(inputs: KeyCreateInput) -> OperationResult[SSHKeyItem]",
            ...
            parameters: [
              ...
              { param: "inputs.bits", type: "int | None", default: "None", description: "Key size in bits (RSA only; default 4096)" },
              { param: "inputs.comment", type: "str | None", default: "None", description: "Key comment" },
              { param: "inputs.set_default", type: "bool", default: "False", description: "Set as default after creation" },
              { param: "inputs.overwrite", type: "bool", default: "False", description: "Overwrite existing key" },
              { param: "inputs.output_dir", type: "Path | None", default: "None", description: "Output directory for the keypair" },
            ],
          },
          {
            signature: "KeyOperation.add(name: str, pub_key_path: Path, overwrite: bool = False) -> OperationResult[SSHKeyItem]",
          ...
          {
            signature: "KeyOperation.inspect(inputs: KeyInput, is_json: bool = False) -> SSHKeyItem | dict[str, Any]",
            description: "Show detailed key information.",
          },
          {
            signature: "KeyOperation.set_default(inputs: KeyInput) -> OperationResult[SSHKeyItem]",
          ...
          {
            signature: "KeyOperation.remove(inputs: KeyInput) -> BatchResult[SSHKeyItem]",
            description: "Remove keys from the cache.",
          },
          {
            signature: "KeyOperation.export(inputs: KeyInput, destination: Path, overwrite: bool = False) -> OperationResult[tuple[Path, Path]]",
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "BinaryOperation.pull(inputs: BinaryPullInput) -> OperationResult[list[BinaryItem]] | NeedsInteraction",
            description: "Pull (download) a specific Firecracker/jailer binary version from GitHub releases.",
            parameters: [
          ...
          {
            signature: "BinaryOperation.remove(inputs: BinaryInput, force: bool = False) -> BatchResult[BinaryItem]",
            description: "Remove binaries by identifier.",
          },
          {
            signature: "BinaryOperation.remove_by_version(version: str, force: bool = False) -> OperationResult[None]",
          ...
          {
            signature: "BinaryOperation.get(inputs: BinaryInput) -> list[BinaryItem]",
            description: "Get a binary by name and version.",
          },
          {
            signature: "BinaryOperation.set_default(inputs: BinaryInput) -> OperationResult[BinaryItem]",
            description: "Set a binary (by ID) as the active default.",
          },
          {
            signature: "BinaryOperation.ensure_default() -> OperationResult[BinaryItem]",
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "HostOperation.init(cache_dir: Path, *, on_progress: Callable[[ProgressEvent], None] | None = None) -> OperationResult[Any] | NeedsInteraction",
            description:
          ...
          {
            signature: "HostOperation.clean(cache_dir: Path) -> OperationResult[list[str]]",
            description: "Remove all networking config (bridges, TAPs, iptables rules). Does not touch sysctl, sudoers, or group.",
          },
          {
            signature: "HostOperation.reset(cache_dir: Path) -> OperationResult[list[str]]",
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "CacheOperation.init_all(*, on_progress: Callable[[ProgressEvent], None] | None = None) -> OperationResult[dict[str, str | list[str] | None]]",
            description: "Initialize all cache directories and optionally build the libguestfs fixed appliance.",
          },
          {
            signature: "CacheOperation.prune_vms(dry_run: bool = False, include_all: bool = False) -> OperationResult[list[str]]",
            description: "Prune VMs. By default prunes all except RUNNING/STARTING.",
          },
          {
            signature: "CacheOperation.prune_networks(dry_run: bool = False, include_all: bool = False) -> OperationResult[list[str]]",
            description: "Prune unused networks.",
          },
          {
            signature: "CacheOperation.prune_images(dry_run: bool = False, include_all: bool = False) -> OperationResult[list[str]]",
            description: "Prune unused images.",
          },
          {
            signature: "CacheOperation.prune_kernels(dry_run: bool = False, include_all: bool = False) -> OperationResult[list[str]]",
            description: "Prune unused kernels.",
          },
          {
            signature: "CacheOperation.prune_binaries(dry_run: bool = False, include_all: bool = False) -> OperationResult[list[str]]",
            description: "Prune unused binaries.",
          },
          {
            signature: "CacheOperation.prune_misc(dry_run: bool = False) -> OperationResult[dict[str, bool]]",
            description: "Prune misc cache (libguestfs appliance, warm images).",
          },
          {
            signature: "CacheOperation.prune_all(dry_run: bool = False, include_all: bool = False) -> OperationResult[PruneAllResult]",
            description: "Prune all cache resources in one call.",
          },
          {
            signature: "CacheOperation.clean(dry_run: bool = False) -> OperationResult[CleanResult]",
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "SSHOperation.connect(inputs: SSHInput) -> OperationResult[int]",
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "ConsoleOperation.get_connection_info(identifier: str) -> ConsoleConnectionInfo",
            description: "Get connection info (socket path) for attaching to a VM serial console.",
          },
          {
            signature: "ConsoleOperation.get_state(identifier: str) -> dict[str, Any]",
            description: "Check the console relay state for a VM (running, PID, socket path).",
          },
          {
            signature: "ConsoleOperation.kill(identifier: str) -> OperationResult[bool]",
    ...
    operations: [
      {
        ...
        methods: [
          ...
          {
            signature: "ConfigOperation.set(category: str, key: str, value: Any) -> OperationResult[None]",
            description: "Set a config value persistently in config.json.",
          },
          {
            signature: "ConfigOperation.reset(category: str | None = None, key: str | None = None, all_overrides: bool = False) -> OperationResult[int]",
    ...
    operations: [
      {
        ...
        methods: [
          {
            signature: "InitOperation.run(skip_host: bool = False, non_interactive: bool = False, *, on_progress: Callable[[ProgressEvent], None] | None = None, sudo_completed: bool = False, host_setup_message: str | None = None, download_version: str | None = None, guestfs_enabled: bool | None = None) -> InitResult",
          ...
          {
            signature: "InitOperation.setup_host(cache_dir: Path) -> OperationResult[Any] | NeedsInteraction",
...

  {
    ...
    code: {
      code: [
        ...
        "    if result.item:",
        '        print(f"Host init applied: {result.message}")',
        "    else:",
        '        print("Host already configured.")',
        "",
        "    # 3. Ensure a Firecracker binary is available",
        '    BinaryOperation.pull(BinaryPullInput(version="1.15.0"))',
        "",
        ...
        "    )",
        "    if key_result.item:",
        '        print(f"Created SSH key: {key_result.item.name} ({key_result.item.fingerprint})")',
        "",
        "    # 5. Ensure the default network exists",
        "    net_result = NetworkOperation.create_default_network()",
        "    if net_result.item:",
        '        print(f"Default network: {net_result.item.name} ({net_result.item.subnet})")',
        "",
